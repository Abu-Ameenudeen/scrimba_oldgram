...
## 🚀 Features
 ...
 - Reusable post layout (no hard-coded HTML posts)
  
 - Profile header with avatar and location
  
 - Like, comment, and DM reaction icons with hover effects
  
 - Instagram-style post dividers
  
 - Clean typography using Google Fonts (Source Sans 3)
...
Looping through objects to generate UI

Template literals for dynamic HTML

Separation of concerns (HTML, CSS, JS)

Flexbox layout and spacing (gap)

Hover and active UI states
...
CSS3 – Flexbox, hover effects, layout styling
...
Each object is converted into HTML using template literals

Generated markup is injected into the DOM

CSS handles layout, spacing, and interactions
